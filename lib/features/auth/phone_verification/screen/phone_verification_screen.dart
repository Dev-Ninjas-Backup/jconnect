...
import 'package:jconnect/features/auth/phone_verification/widget/verificaion_code_field.dart';
...
class PhoneVerificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final verificationController = List.generate(
      4,
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            VerificaionCodeField(codeControllers: verificationController),
